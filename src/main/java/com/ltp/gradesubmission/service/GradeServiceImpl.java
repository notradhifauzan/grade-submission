...
public class GradeServiceImpl implements GradeService {
    ...
    public Grade saveGrade(Grade grade, Long studentId, Long courseId) {
        Student student = StudentServiceImpl.unwrapStudent(studentRepository.findById(studentId), courseId);
        Course course = CourseServiceImpl.unwrapCourse(courseRepository.findById(courseId), courseId);

        // throw exception if student is not enrolled in that course
    ...
    public Grade updateGrade(String score, Long studentId, Long courseId) {
        ...
        // unwrap the grade:
        // if exist, return grade else throw exception
